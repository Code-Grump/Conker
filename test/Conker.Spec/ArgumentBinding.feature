...
Scenario: Try bind non-numeric to Int32
	...
	Then the application prints the error "cannot use 'potato' as the 'id' parameter; could not convert to a System.Int32"
...
Scenario: Try bind decimal to Int32
	...
	Then the application prints the error "cannot use '123.456' as the 'id' parameter; could not convert to a System.Int32"
...
Scenario: Try bind non-numeric to Double
	...
	| size | Double |
	When I run my application with the args "potato"
	Then the application prints the error "cannot use 'potato' as the 'size' parameter; could not convert to a System.Double"